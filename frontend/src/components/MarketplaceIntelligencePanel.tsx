      ...
      <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-chumbo-800 dark:bg-gradient-to-r dark:from-chumbo-900 dark:via-chumbo-950 dark:to-chumbo-900 dark:shadow-xl">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="rounded-full border border-amber-800 bg-amber-700 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-white shadow-sm dark:border-amber-500/30 dark:bg-amber-500/20 dark:text-amber-400">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center gap-1 rounded-xl border border-slate-200 bg-slate-100 p-1 dark:border-chumbo-800 dark:bg-chumbo-950">
              <button
                type="button"
                onClick={() => handleSwitchProvider('mercadolivre')}
                className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-bold transition-all ${
                  provider === 'mercadolivre'
                    ? 'bg-amber-700 text-white shadow-sm dark:bg-amber-400 dark:text-chumbo-950'
        ...
        <div className="space-y-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="text-xs text-slate-500 dark:text-slate-400">
              Exibindo <span className="font-bold text-amber-700 dark:text-amber-400">{trends.length}</span> buscas em alta no Mercado Livre Brasil
            </div>
          </div>
